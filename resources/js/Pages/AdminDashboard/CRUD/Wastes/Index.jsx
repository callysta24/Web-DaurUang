...
const Index = ({ wastes }) => {
    ...
    useEffect(() => {
        ...
        const fetchCategories = async () => {
            try {
                const response = await axios.get("/api/waste-categories"); // Ganti URL dengan URL yang sesuai dengan endpoint backend Anda
                setCategories(response.data); // Simpan data categories ke state
                console.log(response.data, "halo kategori");
                // console.log(response.data.data.category_name, "halo kategori");
            } catch (error) {
